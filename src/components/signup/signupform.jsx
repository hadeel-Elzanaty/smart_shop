                ...
                <div className='formdiv'>
                    ...
                    <Formik
                        ...
                        validate={values => {
                            ...
                            if (!values.email) {
                                errors.email = 'Email cannot be an empty field';
                            }
                            else if (
                            ...
                            if (!values.password) {
                                ...
                                errors.password = 'Password should be include A capital letter, a small letter, and a number ';
                            }
                        ...
                        onSubmit={async (values, { setSubmitting }) => {
                            try {
                                const response = await axios.post("https://e-commerce-api-3br8.onrender.com/signup/", values)
                            ...
                            <Form>
                                ...
                                <div className='emaildiv'>
                                    <svg className='mt-2 ml-3' xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 25" fill="none">
                                        <path d="M22 6.22656C22 5.12656 21.1 4.22656 20 4.22656H4C2.9 4.22656 2 5.12656 2 6.22656V18.2266C2 19.3266 2.9 20.2266 4 20.2266H20C21.1 20.2266 22 19.3266 22 18.2266V6.22656ZM20 6.22656L12 11.2266L4 6.22656H20ZM20 18.2266H4V8.22656L12 13.2266L20 8.22656V18.2266Z" fill="black" fillO
                                        pacity="0.2" />
                                    </svg>
                                ...
                                <ErrorMessage name="rePassword" component="div" className='errMessage' />
                                <hr />
                                ...
                                <ul className='d-flex inline-flex mt-2'>
                                    <li className='me-2'>
                                    ...
                                    <li className='me-2'>
                                        <Link to='http://pinterest.com' >
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37" viewBox="0 0 58 59" fill="none">
                                                <g clip-path="url(#clip0_190_2594)">
