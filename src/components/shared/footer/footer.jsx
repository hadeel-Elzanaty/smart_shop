 ...
 const Footer = () => {
    return (
        <div className='footerDiv'>
                ...
                <ul className='d-flex inline-flex'>
                    <li>
                        <Link to='http://whatsapp.com' >
                            <svg xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 59 58" fill="none">
                    ...
                    <li>
                        <Link to='http://youtube.com' >
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 65 58" fill="none">
                    ...
                    <li>
                        <Link to='http://twitter.com' >
                            <svg xmlns="http://www.w3.org/2000/svg" width="47" height="47" viewBox="0 0 56 58" fill="none">
            ...
            <h5>
                جميع حقوق النشر محفوظة لشركة سمارت كود
            </h5>
        </div>
    )
}
